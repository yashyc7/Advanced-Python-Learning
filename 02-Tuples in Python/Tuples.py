...
print(
    mytuple.count("cherry")
)  # return the number of occurences in tuple for example here the output is 1 since it exists only one time in the tuple


print(
    "first occurence of cherry in the tuple is at index ", mytuple.index("cherry")
)  # return the first occurence index of the element
...
b = a[
    2:5
]  # output (4, 23, 53) since last index is excluded like 5th index 64 is excluded
print(b)
